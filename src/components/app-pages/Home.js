            ...
            <SectionsContainer {...options}>
                <Section>
                    <div className={styles.wrap2}>
                      <img className={styles.img} src="./image.jpg" alt="사업장 디자인 이미지" />
                      <div className={styles.infotext}>
                        <h1 className={styles.header}>사업장 목록</h1>
                        <h2 className={styles.header2}>여러 사업장을 등록하여 <br></br> 관리할 수 있는 편리함</h2>
                ...
                <Section>
                    <div className={styles.wrap2}>
                        ...
                        <img className={styles.img} src="./image.jpg" alt="직원 관리 이미지" />
                    </div>
                </Section>

                <Section>
                    <div className={styles.wrap2}>
                        <img className={styles.img} src="./image.jpg" alt="급여 관리 이미지" />
                        <div className={styles.infotext}>
                ...
                <Section>
                    <div className={styles.wrap2}>
                        ...
                        <img className={styles.img} src="./image.jpg" alt="일정 관리 이미지" />
                    </div>
                </Section>

                <Section>
                    <div className={styles.lastwrap}>
                        <img className={styles.img} src="./image.jpg" alt="출퇴근 관리 이미지" />
                        <div className={styles.infotext}>
